...
export const UpdateDetails = () => {
     ...
     useEffect(() => {
          if (isLoggedIn) {
               ...
               axios.get('http://localhost:3000/api/v1/students/logged', { withCredentials: true })
                    .then((response) => {
     ...
     const handleSubmit = async (e) => {
          ...
          try {
               const response = await axios.post('http://localhost:3000/api/v1/students/updatedetails', formData, { withCredentials: true });
